...
@section('page-content')
    <div class="card card-body">
        <form action="{{ route('restaurants.update', $restaurant) }}" method="POST" class="form-row">
            @csrf
            @method('PUT')
            ...
            <div class="form-group col-12">
                ...
                <input type="text" name="name" id="name" @class(['form-control', 'is-invalid' => $errors->has('name')])
                    value="{{ old('name', $restaurant->name) }}" autofocus>
            </div>
            ...
            <div class="row col-12">
                <div class="form-group col-6">
                    ...
                    <input type="time" name="coffe_start_at" id="coffe_start_at" @class([
                        ...
                        value="{{ old('coffe_start_at', $restaurant->coffe_start_at) }}">
                </div>
                ...
                <div class="form-group col-6">
                    ...
                    <input type="time" name="coffe_end_at" id="coffe_end_at" @class(['form-control', 'is-invalid' => $errors->has('coffe_end_at')])
                        value="{{ old('coffe_end_at', $restaurant->coffe_end_at) }}">
                </div>
            </div>
            ...
            <div class="row col-12">
                <div class="form-group col-6">
                    ...
                    <input type="time" name="lunch_start_at" id="lunch_start_at" @class([
                        ...
                        value="{{ old('lunch_start_at', $restaurant->lunch_start_at) }}">
                </div>
                ...
                <div class="form-group col-6">
                    ...
                    <input type="time" name="lunch_end_at" id="lunch_end_at" @class(['form-control', 'is-invalid' => $errors->has('lunch_end_at')])
                        value="{{ old('lunch_end_at', $restaurant->lunch_end_at) }}">
                </div>
            </div>
            ...
            <div class="row col-12">
                <div class="form-group col-6">
                    ...
                    <input type="time" name="dinner_start_at" id="dinner_start_at" @class([
                        ...
                        value="{{ old('dinner_start_at', $restaurant->dinner_start_at) }}">
                </div>
                ...
                <div class="form-group col-6">
                    ...
                    <input type="time" name="dinner_end_at" id="dinner_end_at" @class([
                        ...
                        value="{{ old('dinner_end_at', $restaurant->dinner_end_at) }}">
                </div>
            </div>

    ...
    <div class="card card-body">
        <form action="{{ route('posts.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="date" name="published_at" id="published_at" @class(["form-control", 'is-invalid' => $errors->has('published_at')]) value="{{ old('published_at') }}">
            </div>

            <div class="form-group">
                <label for="image_url">Url da Imagem</label>
                <input type="text" name="image_url" id="image_url" @class(["form-control", 'is-invalid' => $errors->has('image_url')]) value="{{ old('image_url') }}">
            </div>

            <div class="form-group">
                <label for="slug">Slug</label>
                <input type="text" name="slug" id="slug" @class(["form-control", 'is-invalid' => $errors->has('slug')]) value="{{ old('slug') }}">
            </div>

        ...
        <form action="{{ route('events.update', $event) }}" method="POST">
            ...
            <div class="row">
                <div class="form-group col-6">
                    ...
                    <input type="date" name="start_at" id="start_at" @class(['form-control', 'is-invalid' => $errors->has('start_at')])
                        value="{{ old('start_at', $event->start_at) }}">
                </div>

                <div class="form-group col-6">
                    <label for="end_at">Data de término</label>
                    <input type="date" name="end_at" id="end_at" @class(['form-control', 'is-invalid' => $errors->has('end_at')])
